...
# Data loader
test_loader = SequenceLoader(data_folder="Pytorch_en_kr_translater/data",  # Change this to the folder containing your data
                             source_suffix="en",
                             target_suffix="kr",
                             split="test",  # test may not available because the problem in README.md
