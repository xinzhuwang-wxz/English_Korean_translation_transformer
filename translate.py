...
# BPE Model
bpe_model = youtokentome.BPE(model="./data/bpe.model")  # Change this path to the path of your BPE model

# Transformer model
checkpoint = torch.load("Pytorch_en_kr_translater/transformer_checkpoint.pth.tar")  # Change this path to the path of your checkpoint
...
if __name__ == '__main__':
    a, _ = translate("I think religion depends on one's mind.")
